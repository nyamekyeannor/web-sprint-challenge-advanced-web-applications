...
1. Explain what a token is used for.
   A token is used to store tamper proof information about a system and make security decisions.

2. What steps can you take in your web apps to keep your data secure?

There are a lot of things a user can do to secure there web app but some examples are:
1: Keeping your Software Up-to-Date
2: Using a secure host
3: Performing web Vulnerabilities scans

3. Describe how web servers work.
   A web server works by storing, processing and delivering web pages to users. Also a DNS translates the URL into an IP address.

4. Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

   we would use the delete - DELETE read - GET create - POST update - PUT method
